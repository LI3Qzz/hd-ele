...
run_tab();
function run_tab(){
	$('.str_title .item').click(function(){
		var id = $(this).attr('id');
		$('.str_title .item').removeClass('activated');
		$(this).addClass('activated');
		sum_id = id.replace('item_','sum_');
		$('.str_summary .sum').addClass('hide');
		$('#'+sum_id).removeClass('hide');

		img_id = id.replace('item_','img_');
		$('.frames_r .img').addClass('hide');
 ...
 var owl = $('.certifications .owl-carousel');
    ...
    $('.certifications .next').click(function() {
      ...
      owl.trigger('next.owl.carousel', [300]);
		...
		type: "POST",
		url: "/index.php?module=projects&view=home&task=fetch_pages2&raw=1",
		data: {0:0},
		cache: false,
		success: function(html){
			$("#box_project").html(html);
...
function load_project(area_id,cat_id){
$.ajax({
		type: "POST",
		url: "/index.php?module=projects&view=home&task=fetch_pages&raw=1",
		data: {cat_id:cat_id},
		cache: false,
		success: function(html){
			$("#box_project").html(html);
...
function load_banner(area_id,cat_id){
	$.ajax({
		type: "POST",
		url: "/index.php?module=projects&view=home&task=fetch_pages2&raw=1",
		data: {cat_id:cat_id},
...
;$('.testimonials_body .video_item .video_item_inner_has_img').click(function(){
	...
	$(this).html('<iframe src="'+link_video+'?rel=0&autoplay=1" width="100%" height="182px" frameborder="0" allowfullscreen="false">');
  ...
  $('.block-news-list-column3').owlCarousel({
      loop:true,
      nav:false,
      dots:false,
      ...
      smartSpeed:1000,
      navText: [
      '<svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="angle-left" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" class="svg-inline--fa fa-angle-left fa-w-6 fa-2x"><path  d="M25.1 247.5l117.8-116c4.7-4.7 12.3-4.7 17 0l7.1 7.1c4.7 4.7 4.7 12.3 0 17L64.7 256l102.2 100.4c4.7 4.7 4.7 12.3 0 17l-7.1 7.1c-4.7 4.7-12.3 4.7-17 0L25 264.5c-4.6-4.7-4.6-12.3.1-17z" class=""></path></svg>',
      '<svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="angle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" class="svg-inline--fa fa-angle-right fa-w-6 fa-2x"><path  d="M166.9 264.5l-117.8 116c-4.7 4.7-12.3 4.7-17 0l-7.1-7.1c-4.7-4.7-4.7-12.3 0-17L127.3 256 25.1 155.6c-4.7-4.7-4.7-12.3 0-17l7.1-7.1c4.7-4.7 12.3-4.7 17 0l117.8 116c4.6 4.7 4.6 12.3-.1 17z" class=""></path></svg>',
      ],
      responsive:{
         0:{
              items:1,
