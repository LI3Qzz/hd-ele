...
//	check_captcha();
	...
	// 		jQuery(smartTab).addClass('fixed');
	// 		jQuery(smartTab).find("li").removeClass("active");
	...
	// 	}else{
	// 		jQuery(smartTab).removeClass('fixed');
	// 	}
	// }
...
//     },
//     initCarousel: function () {function r() {
//             var n = this.currentItem;
//             $("#fowl2").find(".owl-item").removeClass("active").eq(n).addClass("active");
//             $("#fowl2").data("owlCarousel") !== undefined && u(n)
//         }function u(t) {
//             var i = n.data("owlCarousel").owl.visibleItems,
//                 r = t,
//                 u = !1,
//                 f;
//             for (f in i) r === i[f] && (u = !0);
...
//                 n.find(".owl-item").eq(0).addClass("active")
//             }
//         });
//         $("#fowl2").on("click", ".owl-item", function (n) {
//             var t, r;
//             n.preventDefault();
//             t = $(this).data("owlItem");
